...
<table border="0" cellpadding="0" cellspacing="5" align="center">
   <tr><td align="center">{LETTER_HEADING}</td></tr>
   <tr><td align="center"><input type="text" name="user_search" class="post" size="20" maxlength="50" value="{USER_SEARCH}" />
	   &nbsp;<input type="submit" name="submit" class="mainoption" value="{L_SEARCH}" /></td></tr>
</table>
</p>
